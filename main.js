...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'git2';
        this.max = 100;
        this.a = [{ value: 0, error: '' }];
    }
    AppComponent.prototype.addMore = function (i, e) {
        var inputTag = e.target.parentElement.children[1];
        var input = inputTag.value;
        var sum = 0;
        sum = Array.from(document.querySelectorAll("input")).map(function (item) { return parseInt(item.value); }).reduce(function (s, n) { return s + n; });
        var max = this.max;
        if (sum >= max) {
...
module.exports = __webpack_require__(/*! C:\Users\amitk\Desktop\angularclass\git2\src\main.ts */"./src/main.ts");
